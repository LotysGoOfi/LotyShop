...
<head>
    ...
    <title>LotyShop/administration/products</title>
</head>
<body>
<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" href="<c:url value="/administration/products"/>">Products</a>
            </li>
            <li class="nav-item">
...
<div class="container">
    <div class="row">
        ...
        <div class="col">
            <a class="btn btn-primary" href="#" role="button">AddProduct</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <img src="<c:url value="${product.image}"/>" class="img-thumbnail" alt="...">
        </div>
        <div class="col">
                ${product.name}
        </div>
